...
import com.curso.udemmy.models.service.IClienteService;
import com.curso.udemmy.models.service.IUploadFileService;
import com.curso.udemmy.util.paginator.PageRender;
...
public class ClienteController {
	...
	public String editar(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash) {
		...
		if (id > 0) {
			...
			flash.addFlashAttribute("error", "el id del cliente no pude se cero");
			return "redirect:/listar";
		}
		model.put("cliente", cliente);
	...
	public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash) {
		if (id > 0) {
			...
			flash.addFlashAttribute("success", "se elimino correctamente");
